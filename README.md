...
<tr>
  <td><a href = "https://github.com/nikolay-avdeev/car_price">Определение стоимости автомобиля</a></td>
  <td>Яндекс.Практикум</td>
  <td>Сервис по продаже автомобилей с пробегом «Не бит, не крашен» разрабатывает приложение, чтобы привлечь новых клиентов. В нём можно будет узнать рыночную стоимость своего автомобиля. </td>
  <td>Завершен</td>
</tr>
</table>
</details>
...
<tr>
  <td><a href = "https://github.com/nikolay-avdeev/customer_outflow">Прогнозирование оттока клиентов</a></td>
  <td>Яндекс.Практикум</td>
